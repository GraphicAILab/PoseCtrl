...
class UNet2DConditionModel(
    ...
    def forward(
        ...
        # 2. pre-process
        sample = self.conv_in(sample) #torch.Size([1, 320, 64, 64])
...
if __name__ == '__main__':
    ...
    dummy_input = torch.randn(batch_size, 3, height, width)  # 原始的3通道输入
    ...
    pred = unet(dummy_input, dummy_timestep, dummy_encoder_hidden_states)
